...
public class RecordPathManager {
    ...
    // key:"tracking"组     value:order子模块下，对应所有的Activity路径信息
    private static Map<String, List<PathBean>> groupMap = new HashMap<>();

    /**
     * 将路径信息加入全局Map
     *
     * @param groupName 组名，如："tracking"
     * @param pathName  路劲名，如："Tracking_MainActivity"
     * @param clazz     类对象，如：Tracking_MainActivity.class
     */
