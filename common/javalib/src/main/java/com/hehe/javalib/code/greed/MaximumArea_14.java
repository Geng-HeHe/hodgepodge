...
import com.hehe.javalib.map.Map;

public class MaximumArea_14 {
    /**
     * 贪心
    ...
    public int getMaximumArea(int n){
        if (n<2)
            return 0;
        if (n == 2)
            return 1;
        ...
        if (n - instance3*3 == 1)
            instance3--;
        int instance2 = (n - instance3*3)/2;

        return (int) (Math.pow(3,instance3) * Math.pow(2,instance2));
