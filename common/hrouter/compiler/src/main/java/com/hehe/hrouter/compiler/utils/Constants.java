package com.hehe.hrouter.compiler.utils;
...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String HROUTER_ANNOTATION_TYPES = "com.hehe.hrouter.annotation.HRouter";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.hehe.hrouter.annotation.Parameter";
    ...
    // 包名前缀封装
    public static final String BASE_PACKAGE = "com.hehe.hrouter.api";
    // 路由组Group加载接口
    public static final String HROUTE_GROUP = BASE_PACKAGE + ".core.HRouterLoadGroup";
    // 路由组Group对应的详细Path加载接口
    public static final String HROUTE_PATH = BASE_PACKAGE + ".core.HRouterLoadPath";
    // 获取参数，加载接口
